...
class SearchPage(BasePage):
    ...
    ADD_TO_CART_BUTTON = (By.CSS_SELECTOR, "a.btn.buy-link.btn-primary, button.btn-buy")
    CART_COUNTER = (By.CSS_SELECTOR, "span.b-header-b-personal-e-icon-count-m-cart, span.basket-in-cart-a")
    NO_RESULTS_MESSAGE = (By.CSS_SELECTOR, "div.search-error, div.searchnoresults")
    ...
    def wait_for_search_results(self, timeout=10):
        ...
        try:
            self.wait.until(
                lambda d: self.get_search_results_count() > 0 or
